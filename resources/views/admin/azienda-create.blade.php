        ...
        <div class="form-container">
            ...
            <div class="form-input">
                <div class="input-item">
                    ...
                    {{ Form::text('ragioneSociale', null, [ 'id'=>'ragioneSociale', 'class' => 'input']) }}
                </div>
                <div class="input-item">
                    {{Form::label("sede", "Sede:")}}
                    {{ Form::text('sede', null, [ 'id'=>'sede', 'class' => 'input']) }}
                </div>
                <div class="input-item">
                    {{Form::label("tipologia", "Tipologia: ")}}
                    {{ Form::text('tipologia',null, [ 'id'=>'tipologia', 'class' => 'input']) }}
                </div>
                <div class="input-item">
                    {{ Form::label("logo", "Logo: ") }}
                    {{ Form::file("logo", ["id" => "logo" , "accept" => ".jpg, .jpeg, .png", 'class' => 'input' ]) }}
                </div>
