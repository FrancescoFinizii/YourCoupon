        ...
        <div class="card">
            ...
            <form class="myform" method="post">
                <input id="email" type="email" placeholder="Email"
                       pattern="^[\w-\.]+@([\w-]+\.)+[\w-]{2,4}$" required maxlength="30"/>
                <input id="password" type="password" placeholder="Password"
                       required maxlength="15" minlength="8"/>
                <button class="btn btn-blue btn-large" type="submit">Log in</button>
            </form>
            <p>Not a Member? <a class="std-link" href="{{url("/registration")}}">Sign Up</a></p>
        </div>
    </div>
@endsection
