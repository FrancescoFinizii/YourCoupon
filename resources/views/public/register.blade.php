...
@section("content")
    <div class="background" style="background-image:url({{url('img/background.jpg')}});">
        <div class="card">
            ...
            {{ Form::text('nome', '', ['id' => 'nome', "class" => "input", 'placeholder'=>'Nome']) }}
            @if ($errors->has('nome'))
            ...
            {{ Form::text('cognome', '', ['id' => 'cognome', "class" => "input", 'placeholder'=>'Cognome']) }}
            ...
            {{ Form::text('username', '', ['id' => 'username', "class" => "input", 'placeholder'=>'Username']) }}
            ...
            {{ Form::Email('email', '', ['id' => 'email', "class" => "input", 'placeholder'=>'Email']) }}
            @if ($errors->has('email'))
            ...
            {{ Form::text('dataNascita', null, ['id' => 'dataNascita', "class" => "input", "onfocus" => "(this.type='date')", "onblur" => "(this.type='text')", 'placeholder'=>'Data di nascita']) }}
            ...
            {{ Form::text('telefono', '', ['id' => 'telefono', "class" => "input", 'placeholder'=>'Telefono']) }}
            ...
            {{ Form::select('genere', ["Non specificato" => "Non specificato", 'Uomo' => 'Uomo', 'donna' => 'donna'], null, ['id' => 'genere']) }}
