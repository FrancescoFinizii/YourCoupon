<nav class="secondary-navbar staff-nav">
    <ul>
        <li>
            <a href="{{route("staff.edit.profile")}}" class="staff-nav-link flex-centered" data-title="Staff - Profilo">
        ...
        <li>
            <a href="{{route("staff.edit.password")}}" class="staff-nav-link flex-centered" data-title="Staff - Password">
        ...
        <li>
            <a href="{{route("offerta.index")}}" class="staff-nav-link flex-centered" data-title="Offerta - Gestione">
