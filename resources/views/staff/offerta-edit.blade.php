    ...
    <div class="form-container">
        ...
        <div class="form-input">
            ...
            <div class="input-item item-centered">
                ...
                {{ Form::text('oggetto', $offerta->oggetto, [ 'id'=>'oggetto', 'class' => 'input']) }}
            </div>
            <div class="input-item">
                {{Form::label("emissione", "Emissione:")}}
                {{ Form::date('emissione', $offerta->emissione, [ 'id'=>'emissione', 'class' => 'input']) }}
            </div>
            <div class="input-item">
                {{Form::label("scadenza", "Scadenza: ")}}
                {{ Form::date('scadenza', $offerta->scadenza, [ 'id'=>'scadenza', 'class' => 'input']) }}
            </div>
            <div class="input-item">
                {{ Form::label("prezzo", "Prezzo: ") }}
                <div class="flex-centered">
                    {{ Form::number("prezzo", $offerta->prezzo, ["id" => "prezzo" , "class" => 'input' , "step"=>"0.01"]) }}
            ...
            <div class="input-item">
                ...
                <div class="flex-centered">
                    {{ Form::number("sconto", $offerta->sconto, ["id" => "sconto" , "class" => 'input']) }}
                    <span class="suffix">%</span>
                </div>
            </div>
            <div class="input-item two-columns">
                {{Form::label("descrizione", "Descrizione: ")}}
                {{Form::textarea("descrizione", $offerta->descrizione, ['id' => 'descrizione']) }}
            </div>
        </div>
